...
<tr>
   ...
   <td align="left" bgcolor="#EFEFEF"> <font color="#666666"><h5>Edited By:- <?php echo $daslo['username'];?></h5></font>
     ...
     <p><?php echo $daslo['story'];?></p><br><br>
        ...
        <tr><td height="10" width="400"></td></tr>
        <tr><td background="images/brimg.png" height="2" width="400"></td></tr>
        
            <tr><td>
        <?php 
        $subid1=$_GET['subid1'];
	    $asql1=mysql_query("select * from substory where id='$subid1'");
		if(empty($asql1))
		{
			echo "<font color='#FF0000'>Unable to retrived the data</font>";
		}
		while($daslo1=mysql_fetch_array($asql1))
				{
					?><tr>
	
   <td align="left" bgcolor="#EFEFEF"> <font color="#666666"><h5>Edited By:- <?php echo $daslo1['username'];?></h5></font>

     <p><?php echo $daslo1['story'];?></p><br><br>
   </td></tr>
				<?php }
		?>
        </td></tr>
