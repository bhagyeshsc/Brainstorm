...
<div style="position: absolute; left: 1px; top: 116px; width: 1101px; height: 466px;">
  ...
  <div style="position: absolute; left: -196px; top: -22px; width: 118px; height: 87px;"><a href="index.php"><img src="images/homemain.png" width="119" height="89"></a></div>
  ...
  if(empty($_SESSION['user']))
{
	header("location:index.php");
		...
		$myid=$_GET['udi'];
		$sql=mysql_query("select * from artical where username='$myid'");
		if(empty($sql))
		{
